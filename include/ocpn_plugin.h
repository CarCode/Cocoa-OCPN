...
// Beide virtual bool beißen sich mit den gleichnamigen bool in opencpn_plugin_116
...
//    bool RenderGLOverlayMultiCanvas(wxGLContext *pcontext, PlugIn_ViewPort *vp, int canvasIndex,int priority = -1);
 virtual bool RenderGLOverlayMultiCanvas(wxGLContext *pcontext, PlugIn_ViewPort *vp, int canvasIndex, int priority = -1);
  ...
  // when priority is OVERLAY_LEGACY (0)
  // \return true if overlay was rendered, false otherwise
//    bool RenderOverlayMultiCanvas(wxDC &dc, PlugIn_ViewPort *vp,int canvasIndex, int priority = -1);
...
/*  Query driver attributes  */ // Not used
