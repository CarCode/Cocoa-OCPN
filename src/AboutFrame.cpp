...
AboutFrame::AboutFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_scrolledWindowAbout = new wxScrolledWindow( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxVSCROLL );
	...
	m_staticTextOr = new wxStaticText( m_scrolledWindowAbout, wxID_ANY, _("or"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextLogfile = new wxStaticText( m_scrolledWindowAbout, wxID_ANY, _("Logfile:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextIniFile = new wxStaticText( m_scrolledWindowAbout, wxID_ANY, _("Config file:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_htmlWinAuthors = new wxHtmlWindow( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_AUTO );
...
#ifdef __WXOSX__
    m_hyperlinkWebsite = new wxHyperlinkCtrl( m_panelMainLinks, wxID_ANY, _("OpenCPN Website"), wxT("https://topperdiek.de/dl/ocpn"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
#else
...
#ifdef __WXOSX__
    m_hyperlinkHelp = new wxHyperlinkCtrl( m_panelMainLinks, wxID_ANY, _("Info"), wxT("file://hilfe.html"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
#else
	m_hyperlinkHelp = new wxHyperlinkCtrl( m_panelMainLinks, wxID_ANY, _("Help"), wxT("file://index.html"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
#endif
	m_hyperlinkHelp->SetNormalColour( wxColour( 255, 255, 255 ) );
	m_hyperlinkHelp->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxEmptyString ) );

	bSizerLinksInner->Add( m_hyperlinkHelp, 0, wxALL, 20 );

	m_hyperlinkLicense = new wxHyperlinkCtrl( m_panelMainLinks, wxID_ANY, _("License"), wxT("file://license.html"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );

	m_hyperlinkLicense->SetNormalColour( wxColour( 255, 255, 255 ) );
	m_hyperlinkLicense->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxEmptyString ) );
	...
	m_hyperlinkIniFile->Connect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( AboutFrame::OnLinkConfigfile ), NULL, this );
	m_htmlWinHelp->Connect( wxEVT_COMMAND_HTML_LINK_CLICKED, wxHtmlLinkEventHandler( AboutFrame::m_htmlWinHelpOnHtmlLinkClicked ), NULL, this );
	m_hyperlinkHelp->Connect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( AboutFrame::OnLinkHelp ), NULL, this );
	m_hyperlinkLicense->Connect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( AboutFrame::OnLinkLicense ), NULL, this );
}
...
AboutFrame::~AboutFrame()
{
	...
	m_hyperlinkIniFile->Disconnect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( AboutFrame::OnLinkConfigfile ), NULL, this );
	m_htmlWinHelp->Disconnect( wxEVT_COMMAND_HTML_LINK_CLICKED, wxHtmlLinkEventHandler( AboutFrame::m_htmlWinHelpOnHtmlLinkClicked ), NULL, this );
	m_hyperlinkHelp->Disconnect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( AboutFrame::OnLinkHelp ), NULL, this );
	m_hyperlinkLicense->Disconnect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( AboutFrame::OnLinkLicense ), NULL, this );
