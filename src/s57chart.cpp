...
wxString s57chart::CreateObjDescriptions( ListOfObjRazRules* rule_list )
{
    ...
    wxArrayString files;
    file.Assign( GetFullPath() );
    wxString AddFiles = wxString::Format(_T("<hr noshade><br><b>Zusatzinfo in Datei: </b> <font size=-2>%s</font><br><table border=0 cellspacing=0 cellpadding=3>"), file.GetFullName() );
    file.Normalize();
