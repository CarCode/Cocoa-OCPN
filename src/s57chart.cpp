...
#ifdef __WXOSX__
//            free(pf);  Resultat: Crash beim Einlesen von neuen ENCs
#endif
            delete pFeat;
...
//        int senc_file_version = senc.getSencReadVersion();  // Not used

//        int last_update = senc.getSENCReadLastUpdate();  // Not used
