...
#ifdef __WXOSX__
    wxString conf = _T("<br><br>    Konfig-Datei Ort: ");
#else
...
#ifdef __WXOSX__
    pHelpTextCtl->Clear();
    wxString *pHelpString = new wxString("Für Hilfe gehen Sie bitte zum OS X Menü Hilfe oben in der Menüzeile. Geben Sie dort Suchbegriffe ein wie z.B. Plugins.", wxConvUTF8);
    pHelpTextCtl->WriteText(*pHelpString);
    delete pHelpString;
#endif
