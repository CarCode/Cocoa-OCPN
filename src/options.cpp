...
#ifndef __WXOSX__
WX_DECLARE_LIST(wxCheckBox , CBList);  // Goes to options.h
#endif
                                        ...
                                        int group_item_spacing )
{
    ...
    m_lcSources = new wxListCtrl( m_pNMEAForm, wxID_ANY, wxDefaultPosition, wxSize( 300, m_fontHeight * 2 ), wxLC_REPORT | wxLC_SINGLE_SEL);
   ...
   // m_stSerBaudrate->Wrap( -1 );
    ...
    wxString m_choicePrecisionChoices[] = {_T( "x" ), _T( "x.x" ), _T( "x.xx" ), _T( "x.xxx" ), _T( "x.xxxx" )};
...
void options::EnableItem( const long index )
{
    if ( index == wxNOT_FOUND ) {
        ...
        ConnectionParams *conn = g_pConnectionParams->Item( m_lcSources->GetItemData( index ) );
        if ( !conn ) return;
                                   ...
                                   int group_item_spacing )
{
    ...
    pTrackDaily = new wxCheckBox( itemPanelShip, ID_DAILYCHECKBOX, _("Automatic Daily Tracks at midnight"));
                                    ...
                                    int group_item_spacing )
{
    ...
    //    m_ChartDisplayPage->SetSizer( itemBoxSizerUI );
        ...
        m_pSlider_Zoom = new wxSlider(m_ChartDisplayPage, ID_CM93ZOOM, 0, -5, 5, wxDefaultPosition, wxSize( 300, 50), wxSL_HORIZONTAL | wxSL_AUTOTICKS | wxSL_LABELS );
...
#ifdef __WXOSX__
    tcDataSelected = new wxListBox( tcPanel, ID_TIDESELECTED, wxDefaultPosition, wxSize( 250, 350 ) );
#else
                               ...
                               int group_item_spacing )
{
    ...
    m_pCheck_CPA_Max = new wxCheckBox( panelAIS, -1, _("No (T)CPA Alerts if target range is greater than (NMi)"));
    ...
    m_pCheck_Hide_Moored = new wxCheckBox( panelAIS, -1, _("Suppress anchored/moored targets, speed max (kn)"));
    ...
    m_pCheck_Scale_Priority = new wxCheckBox( panelAIS, -1, _("Allow attenuation of less critical targets if more than ... targets"));
                              ...
                              int group_item_spacing )
{
    ...
    pResponsive = new wxCheckBox( itemPanelFont, ID_REPONSIVEBOX, _("Enable Scaled Graphics interface"));
    ...
    miscOptions->Add( new wxStaticText(itemPanelFont, wxID_ANY, _("User Interface scale factor")), verticleInputFlags );
    ...
    miscOptions->Add( new wxStaticText(itemPanelFont, wxID_ANY, _("Chart Object scale factor")), verticleInputFlags);
...
void options::CreateControls( void )
{
    ...
    verticleInputFlags = wxSizerFlags(0).Align(wxALIGN_LEFT).Border(wxALL, group_item_spacing);
#else
...
void options::SetInitialSettings( void )
{
    ...
    m_pText_ACRadius->SetValue( wxString::Format( _T("%.3f"), g_n_arrival_circle_radius ) );
