...
int triangulate_monotone_polygons(int nvert, int nmonpoly, int op[][3])
{
  register int i;
  point_t ymax, ymin;
  int p, vfirst, posmax, /* posmin, */ v;  // posmin not used
  ...
  for (i = 0; i < nmonpoly; i++)
    {
      ...
      posmax = /*posmin =*/ mon[i];  // posmin not used
...
//  int t1, t2;
  point_t tpt;
  int /*tritop = 0,*/ tribot = 0, is_swapped = 0;  // tritop not used
  int tmptriseg;
