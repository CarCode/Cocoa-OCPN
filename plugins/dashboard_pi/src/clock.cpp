...
DashboardInstrument_CPUClock::DashboardInstrument_CPUClock( wxWindow *parent, wxWindowID id, wxString title, wxString format ) : DashboardInstrument_Clock( parent, id, title, OCPN_DBP_STC_LAT, format )
{
