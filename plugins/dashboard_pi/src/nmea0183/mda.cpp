...
*/
   ...
   */
   ...
   if ( sentence.IsChecksumBad( sentence.GetNumberOfDataFields() +1) == TRUE || FALSE ) //different vendors have different length of data message and not 24 field as in standard.
   {
