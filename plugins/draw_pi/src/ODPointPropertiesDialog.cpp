...
ODPointPropertiesDialog::ODPointPropertiesDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText3 = new wxStaticText( m_panelBasicProperties, wxID_ANY, _("Name"), wxPoint( 20,-1 ), wxDefaultSize, 0 );
...
#ifdef __WXOSX__
    bSizer12->Add( m_bSizerChangeAllPointIcons, 0, wxEXPAND, 5 );
#else
...
#ifdef __WXOSX__
    bSizer12->Add( bSizerLatLon, 0, wxEXPAND, 5 );
#else
...
#ifdef __WXOSX__
    bSizer18->Add( m_checkBoxFill, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
#else
	...
	wxString m_choicePointRangeRingsNumberChoices[] = { _("None"), wxT("1"), wxT("2"), wxT("3"), wxT("4"), wxT("5"), wxT("6"), wxT("7"), wxT("8"), wxT("9"), wxT("10") };
