...
#endif
{
    ...
    wxString m_weatherfax_dir  = std_path.GetUserConfigDir();   // should be ~/Library/Preferences
...
#ifdef __WXOSX__
                                  wxCTDS_CAN_PAUSE|wxCTDS_CAN_ABORT|wxCTDS_SHOW_ALL|wxCTDS_AUTO_CLOSE|wxCTDS_CAN_START);
#else
