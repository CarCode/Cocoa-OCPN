...
/*
    ...
    wxString normalIcon = shareLocn + _T("findit.svg");
    wxString toggledIcon = shareLocn + _T("findit-toggled.svg");
    wxString rolloverIcon = shareLocn + _T("findit-rollover.svg");
