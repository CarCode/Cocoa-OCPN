...
{
	public:
        enum FIELDS { BUY,PRIORITY,QUOTA,ACTUELL,TOBUY,UNIT,TEXT,LOC1,LOC2,LOC3,LOC4,LOC5,LOC6,REMARKS};
	...
	protected:
        ...
        void OnGridSelectCellMaterial( wxGridEvent& event );
        void OnGridSelectCellFood( wxGridEvent& event );
        ...
        void setEqualRowHeight(wxGrid* grid, int row);
