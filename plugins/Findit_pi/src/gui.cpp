...
FindItDialog::FindItDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_gridMaterial->SetColLabelValue( 7, _("Location1") );
    m_gridMaterial->SetColLabelValue( 8, _("Location2") );
    m_gridMaterial->SetColLabelValue( 9, _("Location3") );
    m_gridMaterial->SetColLabelValue( 10, _("Location4") );
    m_gridMaterial->SetColLabelValue( 11, _("Location5") );
    m_gridMaterial->SetColLabelValue( 12, _("Location6") );
    ...
    m_gridFood->SetColLabelValue( 7, _("Location1") );
    m_gridFood->SetColLabelValue( 8, _("Location2") );
    m_gridFood->SetColLabelValue( 9, _("Location3") );
    m_gridFood->SetColLabelValue( 10, _("Location4") );
    m_gridFood->SetColLabelValue( 11, _("Location5") );
    m_gridFood->SetColLabelValue( 12, _("Location6") );
    ...
    m_gridLocations->SetColLabelValue( 0, _("Location1") );
    m_gridLocations->SetColLabelValue( 1, _("Location2") );
    m_gridLocations->SetColLabelValue( 2, _("Location3") );
    m_gridLocations->SetColLabelValue( 3, _("Location4") );
    m_gridLocations->SetColLabelValue( 4, _("Location5") );
    m_gridLocations->SetColLabelValue( 5, _("Location6") );
    ...
    m_gridUnits->SetRowLabelSize( 30 );
    m_gridUnits->SetRowLabelAlignment( wxALIGN_CENTRE, wxALIGN_CENTRE );

    // Label Appearance

    // Cell Defaults
    m_gridUnits->SetDefaultCellAlignment( wxALIGN_LEFT, wxALIGN_TOP );
