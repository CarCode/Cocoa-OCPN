...
#ifdef __WXOSX__
#include "../../../src/nmea0183/SatInfo.h"
#else
#include "nmea0183/SatInfo.h"
#endif

class TacticsInstrument_GPS: public TacticsInstrument
{
      public:
            TacticsInstrument_GPS( wxWindow *parent, wxWindowID id, wxString title);

            ~TacticsInstrument_GPS(void){}
