...
GRIBUIDialogBase::GRIBUIDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_cRecordForecast = new wxComboBox( this, wxID_ANY, _("Combo!"), wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
...
//    int m_rbStartOptionsNChoices = sizeof( m_rbStartOptionsChoices ) / sizeof( wxString );
    m_rbStartOptions = new wxRadioBox( this, wxID_ANY, _("Load File Options"), wxDefaultPosition, wxDefaultSize, 2, m_rbStartOptionsChoices, 1, wxRA_SPECIFY_COLS );
...
GribRequestSettingBase::GribRequestSettingBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    wxString m_pMailToChoices[] = { _("Saildocs"), _("zyGrib") };
    ...
    wxString m_pModelChoices[] = { _("GFS"), _("COAMPS"), _("RTOFS") };
    ...
    wxString m_pResolutionChoices[] = { _("0.5"), _("1"), _("2") };
    ...
    wxString m_pIntervalChoices[] = { _("3"), _("6"), _("12"), _("24") };
    ...
    wxString m_pTimeRangeChoices[] = { _("2"), _("3"), _("4"), _("5"), _("6"), _("7"), _("8") };
    ...
    wxString m_pWModelChoices[] = { _("WW3-GLOBAL"), _("WW3-MEDIT") };
    int m_pWModelNChoices = sizeof( m_pWModelChoices ) / sizeof( wxString );
    m_pWModel = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_pWModelNChoices, m_pWModelChoices, 0 );
    m_pWModel->SetSelection( 0 );
    fgSizer10->Add( m_pWModel, 0, wxALL, 5 );
    ...
    m_tFileSize = new wxStaticText( this, wxID_ANY, _("size"), wxDefaultPosition, wxDefaultSize, 0 );
    m_tFileSize->Wrap( -1 );
