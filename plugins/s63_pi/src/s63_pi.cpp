...
wxBEGIN_EVENT_TABLE(S63ScreenLog, wxWindow)
 ...
 */
wxBEGIN_EVENT_TABLE( GetUserpermitDialog, wxDialog )
 ...
 */
wxBEGIN_EVENT_TABLE( GetInstallpermitDialog, wxDialog )
...
void GetInstallpermitDialog::CreateControls()
{
    ...
    wxStaticText* itemStaticText5 = new wxStaticText( itemDialog1, wxID_STATIC, _T(""),
                                                        wxDefaultPosition, wxDefaultSize, 0 );
#ifdef __WXOSX__
    itemStaticBoxSizer4->Add( itemStaticText5, 0, wxALIGN_LEFT | wxLEFT | wxRIGHT | wxTOP | wxEXPAND, 5 );
#else
