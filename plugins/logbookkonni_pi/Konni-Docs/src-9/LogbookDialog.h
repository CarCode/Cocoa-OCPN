...
{
public:
	myBitmapButton( wxWindow* Statusbar, wxWindowID id = wxID_ANY, wxString text = wxEmptyString, const wxBitmap bm = NULL, const wxPoint& pos = wxDefaultPosition, 
...
{
public:
	myBitmapButton( wxWindow* Statusbar, wxWindowID id = wxID_ANY, const wxBitmap bm = wxBitmapButton(), const wxPoint& pos = wxDefaultPosition, 
