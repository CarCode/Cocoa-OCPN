...
static int wxSQLite3FunctionContextExecAuthorizer(void* func, int type, const char* arg1, const char* arg2, const char* arg3,
                                                  const char* arg4
#if WXSQLITE3_USER_AUTHENTICATION
                                                  ,
                                                  const char* arg5
...
class wxSQLite3DatabaseReference {
   public:
    /// Default constructor
    wxSQLite3DatabaseReference(sqlite3* db = NULL) : m_db(db) {
        m_db = db;
        if (m_db != NULL) {
            m_isValid = true;
            m_refCount = 1;
...
class wxSQLite3StatementReference {
   public:
    /// Default constructor
    wxSQLite3StatementReference(sqlite3_stmt* stmt = NULL) : m_stmt(stmt), m_ptrTypes(NULL) {
        m_stmt = stmt;
        if (m_stmt != NULL) {
            m_isValid = true;
            m_refCount = 0;
...
class wxSQLite3BlobReference {
   public:
    /// Default constructor
    wxSQLite3BlobReference(sqlite3_blob* blob = NULL) : m_blob(blob) {
        m_blob = blob;
        if (m_blob != NULL) {
            m_isValid = true;
            m_refCount = 0;
...
wxSQLite3Exception::wxSQLite3Exception(int errorCode, const wxString& errorMsg) : m_errorCode(errorCode) {
    m_errorMessage =
        ErrorCodeAsString(errorCode) + wxS("[") + wxString::Format(wxS("%d"), errorCode) + wxS("]: ") + wxGetTranslation(errorMsg);
}
...
const wxString wxSQLite3Exception::ErrorCodeAsString(int errorCode) {
    ...
    switch (errorCode) {
        case SQLITE_OK:
            return wxS("SQLITE_OK");
        case SQLITE_ERROR:
            return wxS("SQLITE_ERROR");
        case SQLITE_INTERNAL:
            return wxS("SQLITE_INTERNAL");
        case SQLITE_PERM:
            return wxS("SQLITE_PERM");
        case SQLITE_ABORT:
            return wxS("SQLITE_ABORT");
        case SQLITE_BUSY:
            return wxS("SQLITE_BUSY");
        case SQLITE_LOCKED:
            return wxS("SQLITE_LOCKED");
        case SQLITE_NOMEM:
            return wxS("SQLITE_NOMEM");
        case SQLITE_READONLY:
            return wxS("SQLITE_READONLY");
        case SQLITE_INTERRUPT:
            return wxS("SQLITE_INTERRUPT");
        case SQLITE_IOERR:
            return wxS("SQLITE_IOERR");
        case SQLITE_CORRUPT:
            return wxS("SQLITE_CORRUPT");
        case SQLITE_NOTFOUND:
            return wxS("SQLITE_NOTFOUND");
        case SQLITE_FULL:
            return wxS("SQLITE_FULL");
        case SQLITE_CANTOPEN:
            return wxS("SQLITE_CANTOPEN");
        case SQLITE_PROTOCOL:
            return wxS("SQLITE_PROTOCOL");
        case SQLITE_EMPTY:
            return wxS("SQLITE_EMPTY");
        case SQLITE_SCHEMA:
            return wxS("SQLITE_SCHEMA");
        case SQLITE_TOOBIG:
            return wxS("SQLITE_TOOBIG");
        case SQLITE_CONSTRAINT:
            return wxS("SQLITE_CONSTRAINT");
        case SQLITE_MISMATCH:
            return wxS("SQLITE_MISMATCH");
        case SQLITE_MISUSE:
            return wxS("SQLITE_MISUSE");
        case SQLITE_NOLFS:
            return wxS("SQLITE_NOLFS");
        case SQLITE_AUTH:
            return wxS("SQLITE_AUTH");
        case SQLITE_FORMAT:
            return wxS("SQLITE_FORMAT");
        case SQLITE_RANGE:
            return wxS("SQLITE_RANGE");
        case SQLITE_NOTADB:
            return wxS("SQLITE_NOTADB");
        case SQLITE_ROW:
            return wxS("SQLITE_ROW");
        case SQLITE_DONE:
            return wxS("SQLITE_DONE");
        // Extended error codes
        case SQLITE_IOERR_READ:
            return wxS("SQLITE_IOERR_READ");
        case SQLITE_IOERR_SHORT_READ:
            return wxS("SQLITE_IOERR_SHORT_READ");
        case SQLITE_IOERR_WRITE:
            return wxS("SQLITE_IOERR_WRITE");
        case SQLITE_IOERR_FSYNC:
            return wxS("SQLITE_IOERR_FSYNC");
        case SQLITE_IOERR_DIR_FSYNC:
            return wxS("SQLITE_IOERR_DIR_FSYNC");
        case SQLITE_IOERR_TRUNCATE:
            return wxS("SQLITE_IOERR_TRUNCATE");
        case SQLITE_IOERR_FSTAT:
            return wxS("SQLITE_IOERR_FSTAT");
        case SQLITE_IOERR_UNLOCK:
            return wxS("SQLITE_IOERR_UNLOCK");
        case SQLITE_IOERR_RDLOCK:
            return wxS("SQLITE_IOERR_RDLOCK");
        case SQLITE_IOERR_DELETE:
            return wxS("SQLITE_IOERR_DELETE");
#if SQLITE_VERSION_NUMBER >= 3004000
        case SQLITE_IOERR_BLOCKED:
            return wxS("SQLITE_IOERR_BLOCKED");
#endif
#if SQLITE_VERSION_NUMBER >= 3005001
        case SQLITE_IOERR_NOMEM:
            return wxS("SQLITE_IOERR_NOMEM");
#endif
#if SQLITE_VERSION_NUMBER >= 3006000
        case SQLITE_IOERR_ACCESS:
            return wxS("SQLITE_IOERR_ACCESS");
        case SQLITE_IOERR_CHECKRESERVEDLOCK:
            return wxS("SQLITE_IOERR_CHECKRESERVEDLOCK");
#endif
#if SQLITE_VERSION_NUMBER >= 3006002
        case SQLITE_IOERR_LOCK:
            return wxS("SQLITE_IOERR_LOCK");
#endif
#if SQLITE_VERSION_NUMBER >= 3006007
        case SQLITE_IOERR_CLOSE:
            return wxS("SQLITE_IOERR_CLOSE");
        case SQLITE_IOERR_DIR_CLOSE:
            return wxS("SQLITE_IOERR_DIR_CLOSE");
#endif
#if SQLITE_VERSION_NUMBER >= 3007000
        case SQLITE_IOERR_SHMOPEN:
            return wxS("SQLITE_IOERR_SHMOPEN");
        case SQLITE_IOERR_SHMSIZE:
            return wxS("SQLITE_IOERR_SHMSIZE");
        case SQLITE_IOERR_SHMLOCK:
            return wxS("SQLITE_IOERR_SHMLOCK");
        case SQLITE_LOCKED_SHAREDCACHE:
            return wxS("SQLITE_LOCKED_SHAREDCACHE");
        case SQLITE_BUSY_RECOVERY:
            return wxS("SQLITE_BUSY_RECOVERY");
        case SQLITE_CANTOPEN_NOTEMPDIR:
            return wxS("SQLITE_CANTOPEN_NOTEMPDIR");
#endif
#if SQLITE_VERSION_NUMBER >= 3007007
        case SQLITE_CORRUPT_VTAB:
            return wxS("SQLITE_CORRUPT_VTAB");
        case SQLITE_READONLY_RECOVERY:
            return wxS("SQLITE_READONLY_RECOVERY");
        case SQLITE_READONLY_CANTLOCK:
            return wxS("SQLITE_READONLY_CANTLOCK");
#endif

        case WXSQLITE_ERROR:
            return wxS("WXSQLITE_ERROR");
        default:
            return wxS("UNKNOWN_ERROR");
    }
#endif
}
...
wxSQLite3ResultSet::wxSQLite3ResultSet(wxSQLite3DatabaseReference* db, wxSQLite3StatementReference* stmt, bool eof, bool first) {
    m_db = db;
    if (m_db != NULL) {
        m_db->IncrementRefCount();
    }
...
bool wxSQLite3ResultSet::IsOk() { return (m_db != NULL) && (m_db->m_isValid) && (m_stmt != NULL) && (m_stmt->m_isValid); }
...
bool wxSQLite3Table::IsOk() { return (m_results != 0); }
...
void wxSQLite3Statement::Bind(int paramIndex, const unsigned char* blobValue, int blobLen) {
    CheckStmt();
    int rc = sqlite3_bind_blob(m_stmt->m_stmt, paramIndex, (const void*)blobValue, blobLen, SQLITE_TRANSIENT);
...
void wxSQLite3Statement::Bind(int paramIndex, const wxMemoryBuffer& blobValue) {
    ...
    int rc = sqlite3_bind_blob(m_stmt->m_stmt, paramIndex, (const void*)blobValue.GetData(), blobLen, SQLITE_TRANSIENT);
...
bool wxSQLite3Statement::IsOk() { return (m_db != 0) && (m_stmt != 0); }
...
void wxSQLite3Blob::Write(const wxMemoryBuffer& blobValue, int offset) {
    ...
    if (m_writable) {
        int blobLen = (int)blobValue.GetDataLen();
        int rc = sqlite3_blob_write(m_blob->m_blob, (const void*)blobValue.GetData(), blobLen, offset);
...
bool wxSQLite3Blob::IsOk() { return (m_blob != NULL && m_blob->m_isValid); }

bool wxSQLite3Blob::IsReadOnly() { return !m_writable; }
...
void wxSQLite3Blob::Finalize() { Finalize(m_db, m_blob); }
...
bool wxSQLite3Database::HasUserAuthenticationSupport() { return ms_hasUserAuthentication; }

bool wxSQLite3Database::HasLoadExtSupport() { return ms_hasLoadExtSupport; }

bool wxSQLite3Database::HasNamedCollectionSupport() { return ms_hasNamedCollectionSupport; }

bool wxSQLite3Database::HasIncrementalBlobSupport() { return ms_hasIncrementalBlobSupport; }

bool wxSQLite3Database::HasSavepointSupport() { return ms_hasSavepointSupport; }

bool wxSQLite3Database::HasBackupSupport() { return ms_hasBackupSupport; }

bool wxSQLite3Database::HasWriteAheadLogSupport() { return ms_hasWriteAheadLogSupport; }

bool wxSQLite3Database::HasPointerParamsSupport() { return ms_hasPointerParamsSupport; }
...
bool wxSQLite3Database::IsOpen() const { return (m_db != NULL && m_db->m_isValid && m_isOpen); }
...
void wxSQLite3Database::Backup(wxSQLite3BackupProgress* progressCallback, const wxString& targetFileName, const wxString& key,
...
void wxSQLite3Database::Backup(wxSQLite3BackupProgress* progressCallback, const wxString& targetFileName, const wxMemoryBuffer& key,
                               const wxString& sourceDatabaseName) {
#if SQLITE_VERSION_NUMBER >= 3006011
    CheckDatabase();
    ...
    do {
        ...
        if (progressCallback != NULL) {
            if (!BackupRestoreCallback(sqlite3_backup_pagecount(pBackup), sqlite3_backup_remaining(pBackup), progressCallback)) {
                rc = SQLITE_DONE;
            }
        }
#if 0
...
void wxSQLite3Database::Restore(wxSQLite3BackupProgress* progressCallback, const wxString& sourceFileName, const wxString& key,
...
void wxSQLite3Database::SetBackupRestorePageCount(int pageCount) { m_backupPageCount = pageCount; }

void wxSQLite3Database::Vacuum() { ExecuteUpdate("vacuum"); }
...
int wxSQLite3Database::QueryRollbackState() { return m_lastRollbackRC; }
...
bool wxSQLite3Database::TableExists(const wxString& tableName, const wxString& databaseName) {
    ...
    if (databaseName.IsEmpty()) {
        ...
        sql = wxString(wxS("select count(*) from ")) + databaseName +
              wxString(wxS(".sqlite_master where type='table' and name like ?"));
    }
...
wxSQLite3JournalMode wxSQLite3Database::SetJournalMode(wxSQLite3JournalMode journalMode, const wxString& database) {
...
wxSQLite3JournalMode wxSQLite3Database::GetJournalMode(const wxString& database) {
...
wxString wxSQLite3Database::ConvertJournalMode(wxSQLite3JournalMode mode) {
    ...
    if (mode == WXSQLITE_JOURNALMODE_DELETE)
        journalMode = wxS("DELETE");
    else if (mode == WXSQLITE_JOURNALMODE_PERSIST)
        journalMode = wxS("PERSIST");
    else if (mode == WXSQLITE_JOURNALMODE_OFF)
        journalMode = wxS("OFF");
    else if (mode == WXSQLITE_JOURNALMODE_TRUNCATE)
        journalMode = wxS("TRUNCATE");
    else if (mode == WXSQLITE_JOURNALMODE_MEMORY)
        journalMode = wxS("MEMORY");
    else if (mode == WXSQLITE_JOURNALMODE_WAL)
        journalMode = wxS("WAL");
    else
        journalMode = wxS("DELETE");
    return journalMode;
...
wxSQLite3JournalMode wxSQLite3Database::ConvertJournalMode(const wxString& mode) {
    ...
    if (mode.IsSameAs(wxS("DELETE")))
        journalMode = WXSQLITE_JOURNALMODE_DELETE;
    else if (mode.IsSameAs(wxS("PERSIST")))
        journalMode = WXSQLITE_JOURNALMODE_PERSIST;
    else if (mode.IsSameAs(wxS("OFF")))
        journalMode = WXSQLITE_JOURNALMODE_OFF;
    else if (mode.IsSameAs(wxS("TRUNCATE")))
        journalMode = WXSQLITE_JOURNALMODE_TRUNCATE;
    else if (mode.IsSameAs(wxS("MEMORY")))
        journalMode = WXSQLITE_JOURNALMODE_MEMORY;
    else if (mode.IsSameAs(wxS("WAL")))
        journalMode = WXSQLITE_JOURNALMODE_WAL;
    else
        journalMode = WXSQLITE_JOURNALMODE_DELETE;
    return journalMode;
}
...
wxSQLite3ResultSet wxSQLite3Database::ExecuteQuery(const wxSQLite3StatementBuffer& sql) { return ExecuteQuery((const char*)sql); }
...
wxSQLite3Blob wxSQLite3Database::GetReadOnlyBlob(wxLongLong rowId, const wxString& columnName, const wxString& tableName,
                                                 const wxString& dbName) {
    return GetBlob(rowId, columnName, tableName, dbName, false);
}

wxSQLite3Blob wxSQLite3Database::GetWritableBlob(wxLongLong rowId, const wxString& columnName, const wxString& tableName,
                                                 const wxString& dbName) {
    return GetBlob(rowId, columnName, tableName, dbName, true);
}

wxSQLite3Blob wxSQLite3Database::GetBlob(wxLongLong rowId, const wxString& columnName, const wxString& tableName,
                                         const wxString& dbName, bool writable) {
#if SQLITE_VERSION_NUMBER >= 3004000
    wxCharBuffer strColumnName = columnName.ToUTF8();
    const char* localColumnName = strColumnName;
...
wxString wxSQLite3Database::GetWrapperVersion() { return wxString(wxSQLITE3_VERSION_STRING); }

wxString wxSQLite3Database::GetVersion() { return wxString::FromUTF8(sqlite3_libversion()); }
...
#endif
    int rc = sqlite3_create_function(m_db->m_db, localFuncName, argCount, flags, &function,
                                     (void (*)(sqlite3_context*, int, sqlite3_value**))wxSQLite3FunctionContext::ExecScalarFunction,
                                     NULL, NULL);
    return rc == SQLITE_OK;
}
...
#endif
    int rc = sqlite3_create_function(m_db->m_db, localFuncName, argCount, flags, &function, NULL,
...
void wxSQLite3Database::SetUpdateHook(wxSQLite3Hook* updateHook) {
    ...
    if (updateHook) {
        sqlite3_update_hook(
            m_db->m_db, (void (*)(void*, int, const char*, const char*, wxsqlite_int64))wxSQLite3FunctionContext::ExecUpdateHook,
            updateHook);
    } else {
...
void wxSQLite3Database::SetWriteAheadLogHook(wxSQLite3Hook* walHook) {
    ...
    if (walHook) {
        ...
        sqlite3_wal_hook(m_db->m_db, (int (*)(void*, sqlite3*, const char*, int))wxSQLite3FunctionContext::ExecWriteAheadLogHook,
                         walHook);
    } else {
...
void wxSQLite3Database::WriteAheadLogCheckpoint(const wxString& database, int mode, int* logFrameCount, int* ckptFrameCount) {
#if SQLITE_VERSION_NUMBER >= 3007000
    CheckDatabase();
...
void wxSQLite3Database::SetCollation(const wxString& collationName, wxSQLite3Collation* collation) {
    ...
    if (collation) {
        rc = sqlite3_create_collation(
            m_db->m_db, localCollationName, SQLITE_UTF8, collation,
            (int (*)(void*, int, const void*, int, const void*))wxSQLite3Database::ExecComparisonWithCollation);
    } else {
        rc = sqlite3_create_collation(m_db->m_db, localCollationName, SQLITE_UTF8, NULL,
                                      (int (*)(void*, int, const void*, int, const void*))NULL);
    }
}

void* wxSQLite3Database::GetDatabaseHandle() { return m_db->m_db; }

void wxSQLite3Database::SetCollationNeededCallback() {
    CheckDatabase();
    int rc = sqlite3_collation_needed(m_db->m_db, this,
                                      (void (*)(void*, sqlite3*, int, const char*))wxSQLite3Database::ExecCollationNeeded);
    if (rc != SQLITE_OK) {
        const char* localError = sqlite3_errmsg(m_db->m_db);
        throw wxSQLite3Exception(rc, wxString::FromUTF8(localError));
    }
...
/* static */
int wxSQLite3Database::ExecComparisonWithCollation(void* collation, int len1, const void* text1, int len2, const void* text2) {
...
void wxSQLite3Database::GetMetaData(const wxString& databaseName, const wxString& tableName, const wxString& columnName,
    ...
    int rc = sqlite3_table_column_metadata(m_db->m_db, localDatabaseName, localTableName, localColumnName, &localDataType,
                                           &localCollation, &localNotNull, &localPrimaryKey, &localAutoIncrement);
...
#endif
    {wxS("SQLITE_LIMIT_LENGTH"),          wxS("SQLITE_LIMIT_SQL_LENGTH"),      wxS("SQLITE_LIMIT_COLUMN"),
     wxS("SQLITE_LIMIT_EXPR_DEPTH"),      wxS("SQLITE_LIMIT_COMPOUND_SELECT"), wxS("SQLITE_LIMIT_VDBE_OP"),
     wxS("SQLITE_LIMIT_FUNCTION_ARG"),    wxS("SQLITE_LIMIT_ATTACHED"),        wxS("SQLITE_LIMIT_LIKE_PATTERN_LENGTH"),
     wxS("SQLITE_LIMIT_VARIABLE_NUMBER"), wxS("SQLITE_LIMIT_TRIGGER_DEPTH"),   wxS("SQLITE_LIMIT_WORKER_THREADS")};
...
void wxSQLite3FunctionContext::SetResult(wxLongLong value) { sqlite3_result_int64((sqlite3_context*)m_ctx, value.GetValue()); }
...
/* static */
void wxSQLite3FunctionContext::ExecUpdateHook(void* hook, int type, const char* database, const char* table, wxsqlite_int64 rowid) {
...
/* static */
int wxSQLite3FunctionContext::ExecWriteAheadLogHook(void* hook, void* dbHandle, const char* database, int numPages) {
    wxString locDatabase = wxString::FromUTF8(database);
...
#endif
    {wxS("SQLITE_COPY"),
     wxS("SQLITE_CREATE_INDEX"),
     wxS("SQLITE_CREATE_TABLE"),
     wxS("SQLITE_CREATE_TEMP_INDEX"),
     wxS("SQLITE_CREATE_TEMP_TABLE"),
     wxS("SQLITE_CREATE_TEMP_TRIGGER"),
     wxS("SQLITE_CREATE_TEMP_VIEW"),
     wxS("SQLITE_CREATE_TRIGGER"),
     wxS("SQLITE_CREATE_VIEW"),
     wxS("SQLITE_DELETE"),
     wxS("SQLITE_DROP_INDEX"),
     wxS("SQLITE_DROP_TABLE"),
     wxS("SQLITE_DROP_TEMP_INDEX"),
     wxS("SQLITE_DROP_TEMP_TABLE"),
     wxS("SQLITE_DROP_TEMP_TRIGGER"),
     wxS("SQLITE_DROP_TEMP_VIEW"),
     wxS("SQLITE_DROP_TRIGGER"),
     wxS("SQLITE_DROP_VIEW"),
     wxS("SQLITE_INSERT"),
     wxS("SQLITE_PRAGMA"),
     wxS("SQLITE_READ"),
     wxS("SQLITE_SELECT"),
     wxS("SQLITE_TRANSACTION"),
     wxS("SQLITE_UPDATE"),
     wxS("SQLITE_ATTACH"),
     wxS("SQLITE_DETACH"),
     wxS("SQLITE_ALTER_TABLE"),
     wxS("SQLITE_REINDEX"),
     wxS("SQLITE_ANALYZE"),
     wxS("SQLITE_CREATE_VTABLE"),
     wxS("SQLITE_DROP_VTABLE"),
     wxS("SQLITE_FUNCTION"),
     wxS("SQLITE_SAVEPOINT"),
...
static int intarrayFilter(sqlite3_vtab_cursor* pVtabCursor, int /*idxNum*/, const char* /*idxStr*/, int /*argc*/,
                          sqlite3_value** /*argv*/) {
...
static int intarrayBestIndex(sqlite3_vtab* /*tab*/, sqlite3_index_info* /*pIdxInfo*/) { return SQLITE_OK; }
...
static int chararrayFilter(sqlite3_vtab_cursor* pVtabCursor, int /*idxNum*/, const char* /*idxStr*/, int /*argc*/,
                           sqlite3_value** /*argv*/) {
...
// Analyse the WHERE condition.
static int chararrayBestIndex(sqlite3_vtab* /*tab*/, sqlite3_index_info* /*pIdxInfo*/) { return SQLITE_OK; }
...
wxSQLite3IntegerCollection::wxSQLite3IntegerCollection() : wxSQLite3NamedCollection(wxEmptyString, NULL) {}
...
void wxSQLite3IntegerCollection::Bind(int n, int* integerCollection) {
    sqlite3_intarray* pIntArray = (sqlite3_intarray*)m_data;
    if (m_data != NULL) {
        if (pIntArray->a != NULL && pIntArray->xFree) {
            pIntArray->xFree(pIntArray->a);
...
wxSQLite3StringCollection::wxSQLite3StringCollection() : wxSQLite3NamedCollection(wxEmptyString, NULL) {}
