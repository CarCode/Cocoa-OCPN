...
ObjSearchDialog::ObjSearchDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    // Connect Events
    this->Connect(wxEVT_CHAR_HOOK, wxKeyEventHandler(ObjSearchDialog::ObjSearchDialogOnCharHook));
    this->Connect( wxEVT_SHOW, wxShowEventHandler(ObjSearchDialog::ObjSearchDialogOnShow));
    ...
    m_listCtrlResults->Connect(wxEVT_LEFT_DCLICK, wxMouseEventHandler(ObjSearchDialog::OnLeftDClick), NULL, this);
...
{
    // Disconnect Events
    this->Disconnect(wxEVT_CHAR_HOOK, wxKeyEventHandler(ObjSearchDialog::ObjSearchDialogOnCharHook));
    this->Disconnect( wxEVT_SHOW, wxShowEventHandler(ObjSearchDialog::ObjSearchDialogOnShow));
    ...
    m_listCtrlResults->Disconnect(wxEVT_LEFT_DCLICK, wxMouseEventHandler(ObjSearchDialog::OnLeftDClick), NULL, this);
